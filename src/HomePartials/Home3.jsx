...
const BestProject = () => {
  ...
  const projects = [
    ...
    { id: 6, image: "./projects/p5.webp", title: "ALL PROJECTS", description: "special card", to: "/projects" },
  ];
  ...
  return (
    <div className="bg-[#020617] max-w-8xl mx-auto text-white font-sans p-4 sm:p-6 md:p-8 lg:p-12 mt-5 sm:mt-0">
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-3 sm:p-4 md:p-6">
                ...
                <div className="absolute top-3 right-3 sm:top-4 sm:right-4 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center opacity-100 group-hover:opacity-100 transition-all duration-300">
      ...
      {/* <div className='w-full flex justify-center'>
        <button className='mt-10 font-[font2] text-[1vw] p-2 text-center'>(ALL PROJECTS)</button>
      </div> */}
    </div>
  );
};
